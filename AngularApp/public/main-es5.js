...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(userService, auth, router, renderer, httpClient) {
...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _update_user_update_user_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../update-user/update-user.component */ "./src/app/update-user/update-user.component.ts");
...
var ProfileComponent = /** @class */ (function () {
    function ProfileComponent(auth, authGuard, modalService, router) {
        this.auth = auth;
    ...
    ProfileComponent.prototype.updateUser = function (user) {
        var ref = this.modalService.open(_update_user_update_user_component__WEBPACK_IMPORTED_MODULE_6__["UpdateUserComponent"], { centered: true, windowClass: "update-user-modal" });
...
var UpdateUserComponent = /** @class */ (function () {
    ...
    UpdateUserComponent.prototype.onSubmit = function (updateUserForm) {
        var _this = this;
        ...
        this.isLoading = true;
        this.userService.updateUser(this.updateUserForm.value).subscribe(function (x) {
            _this.isLoading = false;
    ...
    Object.defineProperty(UpdateUserComponent.prototype, "updateUserFormData", {
        get: function () {
    ...
    UpdateUserComponent.prototype.setForm = function (userId) {
        ...
        this.userService.getUserById(userId).subscribe(function (x) {
            ...
            _this.updateUserForm = _this.formBuilder.group({
                _id: [_this.selectedUser._id],
