...
let ProfileComponent = class ProfileComponent {
    constructor(auth, authGuard, modalService, router) {
        this.auth = auth;
...
let UserService = class UserService {
    ...
    getUsers(username) {
        return this.http.get(this.usersURL).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(users => {
            const newUsers = [];
...
let UpdateUserComponent = class UpdateUserComponent {
    constructor(route, userService, formBuilder, router, cdRef) {
        this.route = route;
        this.userService = userService;
    ...
    onSubmit() {
        ...
        if (this.updateUserForm.invalid || this.isLoading) {
            this.updateUserForm.setErrors(Object.assign({}, this.updateUserForm.errors, { 'emailAddressInvalid': true }));
            return;
        }
        this.isLoading = true;
